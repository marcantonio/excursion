...
(let ((test-root-dir "/excursion:localhost#17001:~/test_root/file-modtime/"))
  ...
  (excursion--gen-tests
   ...
   :fixture-fn (lambda (fn &optional args)
                 (with-temp-buffer
                   (setq buffer-file-name (concat test-root-dir "never-existed-file"))
  ...
  (excursion--gen-tests
   ...
   :fixture-fn (lambda (fn &optional args)
                 (with-temp-buffer
                   (setq buffer-file-name (concat test-root-dir "deleted-file"))
